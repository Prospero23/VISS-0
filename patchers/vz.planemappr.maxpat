...
,
		...
		"enablevscroll" : 0,
		"devicewidth" : 0.0,
		"description" : "Change/remap the Red, Green, Blue, and Alpha components in a video",
		"digest" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 80.0, 203.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 164.0, 146.0, 29.5, 22.0 ],
									"text" : "2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 122.0, 146.0, 29.5, 22.0 ],
									"text" : "1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 80.0, 146.0, 29.5, 22.0 ],
									"text" : "0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 80.0, 103.0, 145.0, 22.0 ],
									"text" : "route R G B"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 80.0, 58.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 1108.20001220703125, 110.134155000000007, 53.0, 22.0 ],
...
,
					"patching_rect" : [ 953.20001220703125, 110.134155000000007, 53.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 703.20001220703125, 110.134155000000007, 53.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 449.20001220703125, 110.134155000000007, 53.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"hint" : "Set the plane mapping for the Alpha plane",
					"id" : "obj-65",
					"ignoreclick" : 1,
					...
					"patching_rect" : [ 1074.5, 119.800003051757812, 15.0, 15.0 ],
					"presentation" : 1,
				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_shortname" : "Alpha plane",
							"parameter_enum" : [ "R", "G", "B", "A" ],
							"parameter_type" : 2,
							"parameter_longname" : "Alpha plane",
							"parameter_initial_enable" : 1
						}
				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_mmax" : 26,
							"parameter_initial" : [ 0 ],
							"parameter_shortname" : "Plane mapping",
							...
							"parameter_type" : 2,
							"parameter_longname" : "Plane mapping",
							"parameter_initial_enable" : 1
						}
...
, 			{
				"box" : 				{
					...
					"bordercolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"focusbordercolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"hint" : "Set the plane mapping for the Blue plane",
					"id" : "obj-148",
					"ignoreclick" : 1,
					"maxclass" : "live.toggle",
					"numinlets" : 1,
					...
					"parameter_enable" : 1,
					"parameter_mappable" : 0,
					"patching_rect" : [ 918.70001220703125, 119.800003051757812, 15.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"bordercolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"focusbordercolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"hint" : "Set the plane mapping for the Green plane",
					"id" : "obj-147",
					"ignoreclick" : 1,
					"maxclass" : "live.toggle",
					"numinlets" : 1,
					...
					"parameter_enable" : 1,
					"parameter_mappable" : 0,
					"patching_rect" : [ 668.7783203125, 119.800003051757812, 15.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"bordercolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"focusbordercolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"hint" : "Set the plane mapping for the Red plane",
					"id" : "obj-104",
					"ignoreclick" : 1,
					"maxclass" : "live.toggle",
					"numinlets" : 1,
					...
					"parameter_enable" : 1,
					"parameter_mappable" : 0,
					"patching_rect" : [ 415.70001220703125, 119.800003051757812, 15.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 968.0, 144.56085205078125, 66.0, 23.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1039.0, 77.800003051757812, 88.0, 23.0 ],
					"text" : "data-handler"
				}
...
, 			{
				"box" : 				{
					"comment" : "Set the plane mapping for the Alpha plane",
					"id" : "obj-67",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 812.20001220703125, 148.760848999023438, 66.0, 23.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 562.20001220703125, 148.760848999023438, 67.0, 23.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 87.47479248046875, 177.0, 96.0, 40.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 92.47479248046875, 41.0, 98.0, 23.0 ],
					"text" : "Alpha channel"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 210.0, 615.0, 175.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 233.5, 500.0, 67.0, 22.0 ],
					"text" : "vzgl-object"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 312.20001220703125, 148.760848999023438, 66.0, 23.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 883.20001220703125, 77.800003051757812, 88.0, 23.0 ],
					"text" : "data-handler"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 381.20001220703125, 77.800003051757812, 88.0, 23.0 ],
					"text" : "data-handler"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 632.20001220703125, 77.800003051757812, 88.0, 23.0 ],
					"text" : "data-handler"
				}
...
, 			{
				"box" : 				{
					"comment" : "Set the plane mapping for the Blue plane",
					"id" : "obj-25",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					"comment" : "Set the plane mapping for the Green plane",
					"id" : "obj-12",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					"comment" : "Set the plane mapping for the Red plane",
					"id" : "obj-3",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 188.0, 702.0, 25.0, 25.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 512.9000244140625, 533.04998779296875, 219.5, 533.04998779296875 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-24" : [ "Plane mapping", "Plane mapping", 0 ],
			...
			"obj-26" : [ "Alpha plane", "Alpha plane", 0 ],
			"parameterbanks" : 			{
